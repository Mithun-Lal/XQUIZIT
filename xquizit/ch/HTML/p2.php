...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        ...
        window.open("/timeout/timeout.html","_self")
    }
}, 1000);
</script>
...
<!--                                insertion ends-->
                        ...
                        <div class="col-md-9">
                            ...
                            <!-- Default Blockquote -->
                            <form action="/ch/p3.php" method="POST">
                            <blockquote>
                                <p>
                                    <em>
                                        <?php
                                        ...
                                        if($result->num_rows>0)
                                        {
                                            ...
                                            {   
                                                ...
                                                if($size>=500)
                                                {
                                                    ...
                                                    $dir= 'http://xquizit.conjura.in/ch/HTML';
                                                    $file='imgout1.jpeg';
                                                    echo "Connect";
                                        ...
                                        if($result->num_rows>0)
                                        {
                                            ...
                                            {   
                                                ...
                                                if($size>=500)
                                                {
                                                    ...
                                                    fclose($file);
                                                    echo "stringlen=".strlen($base64_string);
                                                    echo "All of his books follow a similar style of art in the front.Selling millions of copies worldwide,he's one of the most read authors of all time. _Identify the person?_
PS-NO NEED OF FULL NAME";
                                                    $dir= 'http://xquizit.conjura.in/ch/HTML';
                                                    $file='imgout5.jpeg';
                                                   echo "</br>".'<img src="', $dir, '/', $file, '" alt="', $file, '" />';
                                                }
